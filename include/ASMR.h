...
void asmr_cyc_forw(CyclogramOutput *output, SensorData data, ASMR_entry cyc)
{
    ...
    float dist = dist_half_int * 0.5 * CELL_WIDHT * dist_mul;
...
{
    return asmr_prog_couter;
}

// size_t *asmr_get_prog_buffer()
// {
...
void asmr_tick()
{
    ...
    ASMR_entry current_cyc = asmr_prog_buffer[asmr_prog_couter];
